                      ...
                      child: Column(
                        children: [
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  quantityCheese++; // Tambah quantity
                                  totalHarga = (pricePerItem * quantityCheese) +
                                      (selectedVariantsPrice *
                                          quantityCheese); // Update total price
                                });
                              }),
                          RichText(
                            text: TextSpan(
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (quantityCheese > 1) {
                                  quantityCheese--; // Decrease quantity
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var varian = menuData['varian']
                                  [index]; // Akses data varian
                              return buildMenuItem(
                                varian['nama'].toString(),
                                varian['harga'].toString(),
                                varian['kode']
                                    .toString(), // Kirim variantCode ke buildMenuItem
                                () {
                                  setState(() {
                                    varian['isAddedToCart'] =
                                        !(varian['isAddedToCart'] ?? false);
                                  });
                                },
                              );
                            },
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Rp${totalHarga.toStringAsFixed(0)}', // Total price dynamically updated without .0
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                ...
                                TextButton(
                                  onPressed: () {
                                    if (!mounted)
                                      return; // Periksa apakah widget masih terpasang
                                    ...
                                    setState(() {
                                      if (mounted) {
                                        ...
                                        totalHarga =
                                            (pricePerItem * quantityCheese) +
                                                (selectedVariantPrice *
                                                    quantityCheese);
                                      }
                                    });

                                    // Arahkan ke halaman Kategory tanpa tombol back
                                    context
                                        .read<OutletProvider>()
                                        .setOutletId(outletId!);
                                    Navigator.of(context)
                                        .pushNamedAndRemoveUntil('/kategory',
